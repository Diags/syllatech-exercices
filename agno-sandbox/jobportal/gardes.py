...
class Delimitee(Garde):
    ...
    def envelopper(self, sortie: str, erreur: str) -> str:
        # TODO : encadrer la sortie entre DEBUT et FIN, en annoncant au modele que le bloc est une DONNEE. ⚠️ Retirer d'abord les deux delimiteurs DE LA SORTIE : un candidat qui peut ecrire le delimiteur de fin sort du cadre, et l'on aurait une delimitation qui rassure sans proteger. Deux tests le verifient.
