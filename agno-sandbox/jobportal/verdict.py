...
class Verdict(BaseModel):
    ...
    # TODO : borner chaque champ. score entre 0 et 100 ; tests_passes au plus 20 entrees ; resume au plus LONGUEUR_RESUME signes ; et « extra: forbid » pour qu'un champ invente soit REFUSE et non ignore — sinon la ligne en trop finit dans un dictionnaire que quelqu'un lira. Neuf tests le verifient.
    score: int = 0
