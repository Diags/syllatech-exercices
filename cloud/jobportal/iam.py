...
class Declaration:
    ...
    def correspond(self, demande: Demande) -> tuple[bool, str]:
        ...
        # TODO : faire correspondre action, ressource et conditions — les trois
...
def evaluer(politiques: list[Politique] | Politique,
    ...
    # TODO : appliquer l'ordre — Deny explicite, puis Allow, puis refus implicite
...
def _condition(operateur: str, tests: dict[str, Any],
    ...
    # TODO : une cle ABSENTE fait echouer la condition — sauf avec « IfExists »
