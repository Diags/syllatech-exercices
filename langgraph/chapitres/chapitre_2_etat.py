...
# >>> depart: annoter les clés pour obtenir le comportement décrit en commentaire. Une clé sans réducteur est remplacée ; avec un réducteur, elle est combinée.
...
class State(TypedDict):
    messages: Annotated[list, add_messages]        # concatène, et déduplique par id
    etapes: Annotated[list[str], operator.add]     # concatène
    score: int                                     # REMPLACE, faute de réducteur
# <<<
