...
def verifier(dossier: Path) -> tuple[list[str], list]:
    ...
    # TODO : rendre (defauts de forme, trouvailles du scanner). Les premiers viennent de Competence.defauts(), plus le cas « plateformes excluant cette machine » ; les secondes de skills_guard.scan_file sur CHAQUE fichier du dossier, triees par gravite. Deux tests le verifient.
    return [], []
