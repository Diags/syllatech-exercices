...
def couverture() -> dict[str, int]:
    # TODO : compter les outils, les ensembles, les outils rattaches a au moins un ensemble, et les references vers un outil qui n'existe pas. Les deux derniers nombres disent si les deux listes de Hermes sont tenues a jour ensemble. Un test le verifie.
