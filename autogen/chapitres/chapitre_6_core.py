...
async def demonstration() -> None:
    ...
    print("   modele, les outils tiers). Le cours les nomme tous les trois et")
    print("   installe les deux derniers ; ce projet se passe du troisieme,")
    print("   qui demande une cle — d'ou le client ecrit a la main.")
