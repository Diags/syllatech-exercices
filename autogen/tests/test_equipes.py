...
def test_function_calling_a_False_rendrait_l_agent_muet():
    """Ce drapeau n'est pas decoratif : a False, AutoGen refuse de donner des
    outils a l'agent, et l'agent reste muet sans erreur."""
...
async def test_autogen_ext_est_un_paquet_separe():
    """Le cours importe OpenAIChatCompletionClient sans le dire."""
