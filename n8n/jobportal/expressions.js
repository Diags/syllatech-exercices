...
function gabaritSansSigneEgal(valeur) {
  // >>> depart: rendre vrai quand une valeur RESSEMBLE a une expression sans en etre une : elle contient {{ … }} mais ne commence pas par « = ». C'est le defaut le plus silencieux de n8n — le gabarit part tel quel dans le courriel du candidat, sans erreur et sans avertissement. Trois tests le verifient.
  //     return false;
