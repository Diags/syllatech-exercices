...
class PetitMondeNavigable:
    ...
    def ajouter(self, vecteur: list[float], charge: dict) -> int:
        ...
        # TODO : poser l'arete de RETOUR. Sans elle, un noeud insere tard n'est atteignable depuis nulle part et devient invisible a la recherche. Un test le verifie.
        pass
        return i
