...
def _attrape_les_exceptions(fonction) -> bool:
    ...
    # TODO : rendre True si l'entrypoint contient un vrai bloc « try ». ⚠️ Ne PAS chercher la sous-chaine dans le source : getsource inclut la ligne du decorateur, et « @app.en-TRY-point » la contient — le test passerait alors toujours, ce qui vaut exactement un test absent. Passer par l'arbre syntaxique. Un test le verifie.
    return True
