...
def depuis_openapi(spec: dict) -> list[Outil]:
    ...
    """
    # TODO : une operation OpenAPI par outil MCP. Le nom vient de operationId — et, a defaut, de _nom_deduit, ce qui peut produire des DOUBLONS ; la description vient de summary ; les parametres deviennent le schema d'entree, ceux marques required allant dans la liste « required ». Cinq tests le verifient.
