...
def valider_nom(nom: str) -> str | None:
    ...
    """
    # TODO : refuser un nom vide, trop long, ou non conforme a MOTIF_DNS_1123
    return None
...
def _valider_origine(origine: Any) -> list[ErreurDeChamp]:
    ...
    # TODO : faire respecter l'union discriminee — un seul sous-objet, et il doit correspondre a origin.type
    return erreurs
...
def valider_mcpserver(doc: Document) -> list[ErreurDeChamp]:
    ...
    # TODO : exiger exactement un de spec.source et spec.remote, puis valider celui qui est pose
