...
public final class Selection {
    ...
    public static List<Candidat> retenus(List<Candidat> vivier, Offre offre) {
        // TODO : filtrer le vivier avec `offre.convient`, puis trier par experience decroissante et nom croissant
        return List.of();
    }
    ...
    public static int score(Candidat candidat, Offre offre) {
        // TODO : compter POINTS_PAR_COMPETENCE par competence exigee possedee, plus POINTS_PAR_ANNEE par annee au-dela du minimum
        return 0;
    }
    ...
    public static List<String> classement(List<Candidat> vivier, Offre offre,
                                          int combien) {
        // TODO : trier le vivier par score decroissant, garder les `combien` premiers, rendre leurs noms
        return List.of();
    }
    ...
    public static Map<String, Long> parCompetence(List<Candidat> vivier) {
        // TODO : aplatir les competences du vivier et les compter, dans une TreeMap indexee par libelle
        return Map.of();
    }
