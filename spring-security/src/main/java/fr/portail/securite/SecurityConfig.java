...
public class SecurityConfig {
    ...
    SecurityFilterChain chaineApi(HttpSecurity http, JwtDecoder decodeur,
            ...
            throws Exception {
        return http
                // TODO : ouvrir /api/public/**, /oauth2/** et /.well-known/**, reserver /api/rh/** au role RH, fermer le reste
                .authorizeHttpRequests(regles -> regles
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        // TODO : nommer l'origine autorisee, les methodes, les en-tetes, et une duree de cache d'une heure
