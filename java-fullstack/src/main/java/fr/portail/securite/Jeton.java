...
public final class Jeton {
    ...
    public Verdict verifier(String jeton, String usageAttendu,
        ...
        // TODO : verifier le jeton — la signature AVEC L'ALGORITHME DU SERVEUR (jamais celui annonce dans l'en-tete), en temps constant, puis l'expiration, puis l'usage attendu
