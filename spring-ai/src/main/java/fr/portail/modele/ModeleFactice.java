...
public class ModeleFactice implements ChatModel {
    ...
    public reactor.core.publisher.Flux<ChatResponse> stream(Prompt prompt) {
        ...
        // TODO : decouper le texte mot a mot, un ChatResponse par morceau
    ...
    public ChatOptions getOptions() {
        // TODO : rendre des options qui savent porter des ToolCallback — sinon `.tools()` est perdu en silence
