...
public class SecurityConfig {
    ...
    SecurityFilterChain chaine(HttpSecurity http) throws Exception {
        return http
                ...
                // >>> depart: ouvrir /api/public/** et /actuator/health, reserver /api/admin/** au role ADMIN, fermer le reste
                ...
                .authorizeHttpRequests(regles -> regles
                        ...
                        // Tout le reste est ferme. Une route ajoutee demain
                        // est protegee d'office : on ne peut pas oublier de
                        // la securiser, seulement oublier de l'ouvrir — et
                        // cet oubli-la se voit tout de suite.
