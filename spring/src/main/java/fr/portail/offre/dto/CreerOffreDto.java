 ...
 */
// >>> depart: annoter les quatre composants avec les contraintes de Bean Validation et leurs messages
//     public record CreerOffreDto(String titre, int salaireMin,
//                                 String contactEmail, String entreprise) {
//     }
public record CreerOffreDto(

        @NotBlank(message = "le titre est obligatoire")
        @Size(max = 120, message = "le titre fait au plus 120 caracteres")
        String titre,

        @Positive(message = "le salaire minimum est un nombre positif")
        int salaireMin,

        @Email(message = "l'adresse de contact doit etre un courriel")
        @NotBlank(message = "l'adresse de contact est obligatoire")
        String contactEmail,
