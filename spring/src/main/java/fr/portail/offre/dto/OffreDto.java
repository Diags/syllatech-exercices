...
public record OffreDto(Long id, String titre, int salaireMin,
    ...
    public static OffreDto de(Offre offre) {
        // >>> depart: construire le DTO a partir de l'entite, en tolerant une entreprise absente
        //     return new OffreDto(offre.getId(), offre.getTitre(),
        //             offre.getSalaireMin(), null, null);
        var entreprise = offre.getEntreprise();
        return new OffreDto(offre.getId(), offre.getTitre(),
                offre.getSalaireMin(),
                entreprise == null ? null : entreprise.getNom(),
                entreprise == null ? null : entreprise.getVille());
        // <<<
    }
}
