...
class Mesure:
    ...
    def score(self) -> float:
        ...
        """
        # >>> depart: écrire le score agrégé. Les poids sont un CHOIX : justifiez le vôtre en commentaire. Les tests exigent que v1 < v2 < v3.
        #     return 0.0
        return (0.5 * float(self.exactitude)
                + 0.3 * self.ancrage
                + 0.2 * float(self.latence_ok))
        # <<<
