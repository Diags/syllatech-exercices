...
def processus(code: str, delai: float = DELAI) -> Resultat:
    ...
    """
    # TODO : lancer le code dans un interprete SEPARE (sys.executable, -I), avec un delai DUR, dans un dossier temporaire jetable, et un environnement reduit. Sur POSIX, prefixer le code de GARDE pour poser RLIMIT_AS et RLIMIT_NPROC. Cinq tests le verifient.
