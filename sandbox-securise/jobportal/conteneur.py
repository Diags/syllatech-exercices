...
def verifier(ligne: str | list[str]) -> list[Souci]:
    ...
    # TODO : signaler chaque drapeau OBLIGATOIRES absent de la commande, en NOMMANT ce qu'il retire et l'evasion qu'il neutralise. Un drapeau dont on ignore ce qu'il empeche est un drapeau qu'on retire au premier probleme. Un test parametre par drapeau le verifie.
    pass
    ...
    # TODO : signaler les quatre contresens : --user root, --privileged, --network=host, et un montage -v sans « :ro ». Quatre tests parametres le verifient.
    pass
