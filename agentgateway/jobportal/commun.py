...
AMONT = RACINE / "amont"
EXEMPLES_AMONT = AMONT / "exemples"
SCHEMA = AMONT / "config.schema.json"
CONFIGS = RACINE / "configs"
PORTAIL = CONFIGS / "portail"


def utf8() -> None:
    """Les chapitres affichent « pathPrefix » et des guillemets francais.
