...
class Collecteur(SpanExporter):
    ...
    def export(self, spans) -> SpanExportResult:
        for span in spans:
            ...
            # TODO : construire une Observation par span. Garder les IDENTIFIANTS de span et de parent, pas les noms : un enfant se termine — donc s'exporte — AVANT son parent, dont le nom n'est pas encore connu. Trois tests le verifient.
            continue
