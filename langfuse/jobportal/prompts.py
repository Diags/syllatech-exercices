...
class Version:
    ...
    def compile(self, **variables) -> str:
        ...
        """
        # TODO : substituer chaque {{variable}} par sa valeur. Une variable absente doit rester LITTERALE — c'est le comportement reel, et un test l'exige : aucune erreur, juste un prompt qui parle d'une variable au lieu de sa valeur.
        return self.texte
...
class Depot:
    ...
    def publier(self, nom: str, texte: str, modele: str = "haiku",
        ...
        # TODO : retirer le label des versions precedentes. Un label ne pointe que sur UNE version — c'est ce qui fait qu'un deploiement de prompt est instantane, et qu'un retour arriere l'est aussi. Deux tests le verifient.
        pass
