...
| [`java-fullstack/`](java-fullstack) | [Java Fullstack](https://syllatech.pages.dev/cours/java-fullstack) | 76 tests, React mesure en Java, une API Spring Boot reelle, le N+1 compte et un webhook Stripe verifie |
| [`agentscope-java/`](agentscope-java) | [AgentScope Java](https://syllatech.pages.dev/cours/agentscope-java) | 85 tests, le vrai framework — permissions, sous-agents, middleware et etat persistant |
| [`spring-sandbox/`](spring-sandbox) | [Java Spring + Sandbox](https://syllatech.pages.dev/cours/spring-sandbox) | 113 tests, la même batterie hostile des deux côtés de la frontière de processus |

**Les 43 cours ont leur projet.** Un projet n'entre dans ce tableau qu'une fois
**exécuté**, pas une fois écrit.
...
- **JDK 25 et Maven** pour les projets Java (`java-moderne`, `spring`,
  `spring-security`, `spring-ai`, `langchain4j`, `microservices-event`,
  `microservices`, `spring-sandbox`, `agentscope-java`,
  `java-fullstack`) :
