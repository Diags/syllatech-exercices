...
public class ModeleDEmbeddings implements EmbeddingModel {
    ...
    public static float[] vecteur(String texte) {
        ...
        // TODO : normaliser le vecteur — diviser chaque case par la longueur du vecteur, sans diviser par zero
    ...
    public static double similarite(float[] premier, float[] second) {
        // TODO : rendre la similarite cosinus — le produit scalaire des deux vecteurs
        return 0;
    }
}
