...
class Index:
    ...
    def chercher(self, requete: str, combien: int = 3) -> list[dict]:
        notes = []
        # TODO : calculer la note BM25 de chaque document. Pour chaque mot de la requete present dans le document : idf(mot) * f * (K1+1) / (f + K1 * norme), ou norme = 1 - B + B * longueur / moyenne. Ne garder que les notes > 0. Quatre tests le verifient, dont un qui exige que le document le plus LONG ne gagne pas par sa seule taille.
        pass
