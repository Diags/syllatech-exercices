...
def evaluer(modele: ModeleJouet, version: str, gabarit: str,
    ...
    # TODO : soumettre chaque cas du jeu au gabarit, compter les réussites, et GARDER les échecs — un score sans la liste de ce qui a raté ne dit pas quoi corriger.
    reussis, echecs = 0, []
