...
public final class Mesures {
    ...
    public void enregistrer(Resultat resultat) {
        ...
        // TODO : incrementer les trois compteurs d'incident — delai depasse, refus de privilege (code 77) et echec de DEMARRAGE (code -2) — et rien du tout pour un code candidat fautif
    }
