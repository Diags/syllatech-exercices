...
public final class ServiceEvaluation {
    ...
    public static int comparer(String sortie, List<String> attendus) {
        // >>> depart: comparer des CHAINES, ligne a ligne, et rien d'autre — jamais d'evaluation, jamais de moteur de modeles, jamais de requete
        //     return 0;
        List<String> lignes = List.of(Sortie.plafonner(sortie).split("\\R"));
        int reussis = 0;
