...
public final class ExecutionEnBacASable implements ServiceExecution {
    ...
    public Resultat lancer(DemandeExecution demande) {
        ...
        try {
            ...
            // TODO : le delai DUR — attendre au plus `delaiEnSecondes`, puis TUER le processus (pas le lui demander) et rendre un resultat marque « delai depasse »
    ...
    public List<String> commande() {
        ...
        commande.add(java);
        // TODO : borner l'enfant par des drapeaux de JVM — memoire maximale, mort nette sur manque de memoire, un seul cœur
    ...
    private Process demarrer() throws IOException {
        ...
        // TODO : ne laisser passer AUCUNE variable d'environnement de l'application vers l'enfant — une ligne, et un jeton d'API cesse de traverser sans qu'on y pense
